...
from accounts.models import RideRequest,User,DriverCurrentLoc       
...
class CabRequestView(APIView):
    def post(self,request):
        ...
        if ser_data.is_valid():
            ...
            for d_id in drivers:
                lati = DriverCurrentLoc.objects.get(driver_id=d_id).latitude
                lngi = DriverCurrentLoc.objects.get(driver_id = d_id).longitude
